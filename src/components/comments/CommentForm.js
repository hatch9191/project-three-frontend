...
function CommentForm({ setStudio }) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      history.push(`/studios/${studioId}/comments`)
      location.reload()
    } catch (err) {
          ...
          <>
            <Form onSubmit={handleSubmit}>
              <Form.Group className="mb-3 w-25" controlId="exampleForm.ControlInput1">
                ...
                <Form.Select name="rating" onChange={handleChange} aria-label="Rating">
              ...
              <Form.Group className="mb-3 w-50" controlId="exampleForm.ControlTextarea1">
                ...
                <Form.Control name="text" onChange={handleChange} placeholder="How did you like this studio?" as="textarea" rows={3} />
              </Form.Group>
